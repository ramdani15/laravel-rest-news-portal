...
class AuthController extends Controller
{
     ...
     *
     *              @OA\Property(property="email", type="email", example="admin@news-portal.com"),
     ...
     *              @OA\Property(property="email", type="string", example="newuser@news-portal.com"),
    ...
    {
        $data = $request->validated();
        $signup = UserService::register($data);

        return $this->responseJson(
            $signup['status'] ? 'success' : 'error',
            $signup['message'],
            $signup['data'],
            $signup['statusCode']
        );
